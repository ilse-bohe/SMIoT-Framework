...
public class SMIoTPressureSensor extends PressureSensor {
    SMIoTGateway gateway;

    public SMIoTPressureSensor(String systemID, SMIoTGateway gateway) {
        super(systemID);
        this.gateway = gateway;
    }

    @Override
    public void requestPressure(OnRequestCompleted<Double> orc) {
