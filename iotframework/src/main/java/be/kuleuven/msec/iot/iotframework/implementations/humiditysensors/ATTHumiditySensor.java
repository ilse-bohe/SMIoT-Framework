...
public class ATTHumiditySensor extends HumiditySensor {

    String id;

    AllThingsTalkGateway gateway;
    ATTHumiditySensor thisSensor;

    public ATTHumiditySensor(String id, String deviceSystemID, AllThingsTalkGateway gateway) {
    ...
    public void monitorHumidity(final OnEventOccurred<Double> oeo) {
        this.requestHumidity(new OnRequestCompleted<Double>() {
            @Override
            public void onSuccess(Double response) {
                thisSensor.setHumidity(response);
